...
var Cropper = function () {
  ...
  _createClass(Cropper, [{
    ...
    value: function build() {
      ...
      var _template$getElements = template.getElementsByClassName(NAMESPACE + '-container'),
          _template$getElements2 = _slicedToArray(_template$getElements, 1),
          cropper = _template$getElements2[0];

      var _cropper$getElementsB = cropper.getElementsByClassName(NAMESPACE + '-canvas'),
          _cropper$getElementsB2 = _slicedToArray(_cropper$getElementsB, 1),
          canvas = _cropper$getElementsB2[0];

      var _cropper$getElementsB3 = cropper.getElementsByClassName(NAMESPACE + '-drag-box'),
          _cropper$getElementsB4 = _slicedToArray(_cropper$getElementsB3, 1),
          dragBox = _cropper$getElementsB4[0];

      var _cropper$getElementsB5 = cropper.getElementsByClassName(NAMESPACE + '-crop-box'),
          _cropper$getElementsB6 = _slicedToArray(_cropper$getElementsB5, 1),
          cropBox = _cropper$getElementsB6[0];

      var _cropBox$getElementsB = cropBox.getElementsByClassName(NAMESPACE + '-face'),
          _cropBox$getElementsB2 = _slicedToArray(_cropBox$getElementsB, 1),
          face = _cropBox$getElementsB2[0];
      ...
      var _cropper$getElementsB7 = cropper.getElementsByClassName(NAMESPACE + '-view-box');

      var _cropper$getElementsB8 = _slicedToArray(_cropper$getElementsB7, 1);

      this.viewBox = _cropper$getElementsB8[0];
